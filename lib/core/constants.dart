class AppConstants {
  ...
  static const String keyTtsEngine = 'tts_engine'; // 'supertonic3' or 'lite'
  static const String keyTtsLanguage = 'tts_language'; // ISO 639-1, e.g. 'nl'
  ...
  static const String defaultTtsEngine = ttsEngineSupertonic3;
  static const String defaultTtsLanguage = 'nl'; // Flemish-first default
  static const String defaultTtsNeuralVoice = 'F1'; // female neural voice
  ...
  static const String liteDirName = 'eburonvoix-lite';
  static const String liteBundleUrl =
      'https://github.com/k2-fsa/sherpa-onnx/releases/download/tts-models/vits-piper-nl_BE-nathalie-medium-int8.tar.bz2';
  static const String liteEspeakUrl =
      'https://github.com/k2-fsa/sherpa-onnx/releases/download/tts-models/espeak-ng-data.tar.bz2';

  /// All 31 Supertonic 3 languages (ISO 639-1 → display name).
  static const Map<String, String> supertonicLanguages = {
    'en': 'English',
    'ko': 'Korean',
    'ja': 'Japanese',
    'ar': 'Arabic',
  ...
  /// Supertone/supertonic-3 ONNX assets (OpenRAIL-M). Downloaded for the
  /// future on-device engine; synthesis still needs the native runtime.
  static const String supertonicRepo = 'Supertone/supertonic-3';
  static const List<String> supertonicAssetFiles = [
  ...
  static const String supertonicVoiceStyleFile = 'voice_styles/F1.json';

  /// All 10 preset neural voice styles (F1–F5 female, M1–M5 male).
  static const List<String> supertonicNeuralVoices = [
    'F1',
    'F2',
    'F3',
    'F4',
  ...
  static String supertonicAssetUrl(String path) =>
      'https://huggingface.co/$supertonicRepo/resolve/main/$path';

  // System Prompt (compact for small context models)
  static const String systemPrompt =
      '''You are Eburon, created by Master E for Eburon AI founded by Jo Lernout , a helpful and friendly assistant. Be concise, accurate, and conversational. Answer questions directly without unnecessary preamble.''';

  // System Prompt for Uncensored Models
  static const String uncensoredSystemPrompt =
      '''You are Eburon, created by Master E for Eburon AI founded by Jo Lernout  running with an uncensored local model. Be direct, mature, and conversational. Avoid moralizing or unnecessary disclaimers, but keep answers accurate and do not help with real-world harm, abuse, or illegal activity.''';
